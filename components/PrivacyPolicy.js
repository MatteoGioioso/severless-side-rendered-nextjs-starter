...
const PrivacyPolicy = ({ setPrivacyPolicyModal }) => {
  return (
    <nav id="menu">
      <div className="inner" style={{ textAlign: "left" }}>
        <p>
          PRIVACY POLICY <br />
          Last updated June 01, 2019 <br />
          <br />
          ...
          please contact us at info@hirvitek.com.
          <br />
          When you visit our website blog.hirvitek.com, and use our services,
          ...
          through our website (such as blog.hirvitek.com), and/or any related
          services, sales, marketing or events (we refer to them collectively in
          this privacy policy as the "Sites"). Please read this privacy policy
          carefully as it will help you make informed decisions about sharing
          your personal information with us. <br />
          <br />
          WHAT INFORMATION DO WE COLLECT? <br />
          Information automatically collected In Short: Some information – such
          as IP address and/or browser and device characteristics – is collected
          automatically when you visit our Sites.We automatically collect
          certain information when you visit, use or navigate the Sites. This
          ...
          location, information about how and when you use our Sites and other
          technical information. This information is primarily needed to
          maintain the security and operation of our Sites, and for our internal
          analytics and reporting purposes.  Information collected from other
          sources In Short: We may collect limited data from public databases,
          ...
          joint marketing partners, as well as from other third parties.
          ...
          and links, including paid listings (such as sponsored links). <br />
          <br />
          ...
          personal information collected via our Sites for a variety of business
          ...
          the specific processing grounds we rely on next to each purpose listed
          below.  We use the information we collect or receive:   For other
          ...
          experience.  3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?  In
          Short: We only share information with your consent, to comply with
          laws, to protect your rights, or to fulfill business obligations.   We
          may process or share data based on the following legal basis:Consent:
          We may process your data if you have given us specific consent to use
          your personal information in a specific purpose. Legitimate Interests:
          We may process your data when it is reasonably necessary to achieve
          our legitimate business interests. Performance of a Contract: Where we
          ...
          agents who perform services for us or on our behalf and require access
          to such information to do that work. Examples include: payment
          ...
          use tracking technology on the Sites, which will enable them to
          ...
          all or a portion of our business to another company.         4. WHO
          WILL YOUR INFORMATION BE SHARED WITH?  In Short:  We only share
          information with the following third parties.    We only share and
          disclose your information with the following third parties. We have
          categorized each party so that you may be easily understand the
          purpose of our data collection and processing practices. If we have
          processed your data based on your consent and you wish to revoke your
          consent, please contact us.  Web and Mobile AnalyticsGoogle
          AnalyticsWebsite Performance MonitoringSentry   5. HOW LONG DO WE KEEP
          ...
          personal information for longer than 6 months.When we have no ongoing
          ...
          isolate it from any further processing until deletion is possible.6.
          ...
          security measures. We have implemented appropriate technical and
          ...
          transmission of personal information to and from our Sites is at your
          ...
          not knowingly collect data from or market to children under 13 years
          of age.We do not knowingly solicit data from or market to children
          under 13 years of age. By using the Sites, you represent that you are
          at least 13 or that you are the parent or guardian of such a minor and
          ...
          us at info@hirvitek.com. 8. WHAT ARE YOUR PRIVACY RIGHTS? In Short: In
          some regions, such as the European Economic Area, you have rights that
          ...
          withdrawal.If you are resident in the European Economic Area and you
          ...
          here: http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm  9.
          ...
          revised version of this Privacy Policy. 10. DO CALIFORNIA RESIDENTS
          ...
          in California, and have a registered account with the Sites, you have
          the right to request removal of unwanted data that you publicly post
          on the Sites. To request removal of such data, please contact us using
          ...
          the Sites, but please be aware that the data may not be completely or
          comprehensively removed from our systems. <br/><br/>
          11. DO WE MAKE UPDATES TO THIS POLICY? <br/>
          In Short: Yes, we will update this policy as necessary to
          stay compliant with relevant laws.We may update this privacy policy
          ...
          your information. 12. HOW CAN YOU CONTACT US ABOUT THIS POLICY?If you
          have questions or comments about this policy, you may email us at
          info@hirvitek.com or by post to:Matteo Gioioso  __________ Rome, Italy
          __________   Italy
        </p>
      </div>

      <a className="close" onClick={() => setPrivacyPolicyModal(false)}>
        Close
      </a>
    </nav>
  );
